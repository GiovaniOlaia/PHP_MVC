...
class ProdutoDAO extends DAO
{
    ...
    public function insert(ProdutoModel $model)
    {
        ...
        $sql = "INSERT INTO produto (nome, data_fabricacao, data_validade, codigo_de_barras) VALUES (?, ?, ?, ?) ";
        ...
        $stmt->bindValue(4, $model->codigo_de_barras);
    ...
    {
        $sql = "UPDATE produto SET nome=?, data_fabricacao=?, data_validade=?, codigo_de_barras=? WHERE id=? ";
